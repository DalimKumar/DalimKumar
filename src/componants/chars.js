  ...
  return (
    <section class>
      <div class="px-8 py-8 mx-auto sm:py-10 lg:py-20 max-w-7xl">
        <div class="relative py-6 overflow-hidden rounded-lg bg-gradient-to-b from-logo-pink via-fuscia-800 to-purple-600 lg:py-12 md:px-6 lg:p-16 lg:flex lg:items-center lg:justify-between md:shadow-xl md:bg-purple-1000">
          ...
          <div class="relative p-6 rounded-lg md:p-0 md:pb-4">
            ...
            <p class="w-full mt-5 text-base leading-6 text-pink-100 md:w-3/4">
              Get started for free and start engaging with your visitors in
